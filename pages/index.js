...
export default function Home() {
  let pnglink='https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Nextjs-logo.svg/800px-Nextjs-logo.svg.png'
  ...
  return (
   <div className="">
    <Image className='max-w-xs mx-auto md:max-w-sm' src={pnglink} alt="NEXT JS" />
